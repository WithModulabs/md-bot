...
2. Check cookiecutter template values (act name: Md Bot, cast name: Oke)
...
**Condition**:
- Skip if: Cast name already provided by cookiecutter template (Oke)
...
```json
{
  "question": "I see you created a cast called 'Oke'. What should this cast accomplish?",
...
```json
{
  "question": "What is the main goal of Oke Cast?",
  "header": "Cast Goal",
  "options": [
