...
**Steps:**
1. **Md Bot Act Questions** → [modes/initial-design-questions.md](./resources/modes/initial-design-questions.md)
...
**Steps:**
1. **Read CLAUDE.md** → Understand existing Md Bot Act and Casts
